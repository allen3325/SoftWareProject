      ...
      <Container>
        ...
        >
          ...
          <Grid item xs={10} sm={9} md={8}>
            {selectedFolder<folder.length?folder.length > 0 && selectedFolder !== -1? <Cards items={folder[selectedFolder].diary} selectedFolder={folder[selectedFolder].folderName} /> : <p>No folder</p> : <p>No Diary</p>}
          </Grid>
